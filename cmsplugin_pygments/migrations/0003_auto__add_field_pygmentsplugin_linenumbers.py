...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PygmentsPlugin.linenumbers'
        db.add_column('cmsplugin_pygmentsplugin', 'linenumbers', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PygmentsPlugin.linenumbers'
        db.delete_column('cmsplugin_pygmentsplugin', 'linenumbers')
    ...
    complete_apps = ['cmsplugin_pygments']
